...
-- time this table is used. A Unit's id must be a genuine UUIDv7 (see lib_core::RowID),
-- which plain SQL cannot generate -- so the seed happens in Rust at first use, not as an INSERT here.
